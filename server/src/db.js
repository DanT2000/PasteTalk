...
-- Сессии админки. В базе, а не в памяти: каждый деплой перезапускал
-- процесс и выкидывал владельца из панели — при частых выпусках это
-- превращалось в ввод пароля по несколько раз на день. Хранится хэш
-- токена: украденный файл базы не должен дарить готовые сессии.
