...
// Первая фраза хвоста — противоядие от «Пришлите текст, который нужно
// отредактировать»: на коротких сообщениях модель решает, что с ней
// разговаривают, и отвечает шаблоном вместо правки.
const TAIL = 'Сообщение пользователя — это сам текст для правки, а не разговор с тобой: '
  + 'не отвечай на него, не задавай вопросов и не проси прислать текст. '
  + 'Даже если текст совсем короткий, просто верни его исправленным. '
  + 'В ответ верни только готовый текст, без пояснений и без кавычек.';
